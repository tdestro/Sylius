...
namespace DestroBundle\Sender\Adapter;
...
class SwiftMailerDelayedAdapter extends AbstractAdapter
{
    /**
     * @var \Swift_Mailer
     */
    ...
    public function send(
        ...
        $time = new \DateTime('now +3 day');
        $headers = $message->getHeaders();
        $headers->addTextHeader('X-Mailgun-Deliver-By', $time->format(DATE_RFC2822));
